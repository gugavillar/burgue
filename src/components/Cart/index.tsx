...
export const Cart = () => {
  const { cart, result, clearCart, updateQuantityProduct, removeQuantityProduct } = useContext(ProductsContext);
  ...
  return (
    <>
      {result && <h3 className={style.result}>Resultado para: {result}</h3>}
